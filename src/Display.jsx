        ...
        <div className="currentLocation-status">
          ...
          <div className="contryDetails">
            ...
            <div className="confirmedDetails">
              ...
              <label className="confirmed-value active-value">{totalActiveCases ? totalActiveCases : activeCases}</label>
            </div>
            <div className="confirmedDetails">
            ...
            <div className="confirmedDetails">
              <label className="confirmed">{totalNewCases ? `New Cases` : `Total Critical`}</label>
              <label className= {totalNewCases ? `confirmed-value new-value` : `confirmed-value critical-value`} >{totalNewCases ? totalNewCases : totalCritical}</label>
            </div>
          </div>
        </div>
      );
